  ...
  onAdd: function(map) {
    ...
    geocoderService = mbxGeocoder(
      MapboxClient({
        ...
        accessToken: 'pk.eyJ1Ijoic2NvdHQtc3RhZ2luZzEiLCJhIjoiY2pwNHNoOXh0MDFlazN3bmtscGoyaTM1MCJ9.WDsA5z3Z8-WWYh9lJ305PA', //staging token
        origin: this.options.origin || 'https://api-geocoder-staging.tilestream.net'
      })
    );
