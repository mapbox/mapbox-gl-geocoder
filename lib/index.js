...
MapboxGeocoder.prototype = {
  ...
  _onKeyDown: debounce(function(e) {
    ...
    this._geocode(e.target.value, function() {});
  }, 200),
  ...
  _geocode: function(searchInput, callback) {
    this._loadingEl.style.display = 'block';
    this._eventEmitter.emit('loading');
    this.mapboxClient.geocodeForward(searchInput, this.options, function(err, res) {
  ...
  _onQueryResult: function(err, results) {
    if (err || !results.features.length) return;
  ...
  query: function(searchInput) {
    this._geocode(searchInput, this._onQueryResult);
    return this;
  },
