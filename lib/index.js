      ...
      .then(
        function(response) {
          ...
          if (this.options.localGeocoder) {
            ...
            localGeocoderRes = this.options.localGeocoder(searchInput, res.features) || [];

            // supplement Mapbox Geocoding API results with features returned by a promise
            if (typeof localGeocoderRes.then === 'function') {
              return localGeocoderRes.then(function(features) {
