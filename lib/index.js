 ...
 * @param {Object} [options.autoFill] An object mapping query selectors for form inputs to the text of selected result. When a result is selected, the form elements will be automatically populated with the result data. 
...
MapboxGeocoder.prototype = {
  ...
  _autoFill: function (selectedResult) {
    for (let selector in this.options.autoFill) {
      const resultPart = this.options.autoFill[selector];
