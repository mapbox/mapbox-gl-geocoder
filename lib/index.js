 ...
 * 
 * var GeoApi = { 
 *   forwardGeocode: (config) => { return [] },
 *   reverseGeocode: (config) => { return [] } 
 * }
...
MaplibreGeocoder.prototype = {
   ...
   * @param {Function} geocoderApi.forwardGeocode Forward geocode function should return a collection of Features in [Carmen GeoJSON](https://github.com/mapbox/carmen/blob/master/carmen-geojson.md) format
   ...
   *
   * @param {Function} geocoderApi.reverseGeocode Reverse geocode function should return a collection of Features in [Carmen GeoJSON](https://github.com/mapbox/carmen/blob/master/carmen-geojson.md) format
