 ...
 * @param {Boolean|Object} [options.popup=true]  If `true`, a [Popup](https://docs.mapbox.com/mapbox-gl-js/api/markers/#popup) will be added to the map when clicking on a marker using a default set of popup options.  If the value is an object, the popup will be constructed using these options. If `false`, no popup will be added to the map. Requires that `options.mapboxgl` also be set.
...
MaplibreGeocoder.prototype = {
  ...
  _handleMarker: function (selected) {
    ...
    if (this.options.popup) {
      ...
      popup = new this._mapboxgl.Popup(popupOptions).setHTML(
