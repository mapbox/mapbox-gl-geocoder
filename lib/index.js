...
MapboxGeocoder.prototype = {
  ...
  _geocode: function(searchInput) {
    ...
    var mbGeocoderRes = this.mapboxClient.geocodeForward(searchInput, this.options);
    var request;
    
    var localGeocoderRes = Promise.resolve([]); // pass in empty array promise for later handling.
    ...
    request = Promise.all([localGeocoderRes, mbGeocoderRes]);

    request.then(function (responses) {
      // console.log(responses);
      localGeocoderRes = responses[0];
