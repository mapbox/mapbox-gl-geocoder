 ...
 * @param {boolean} [options.feedback=true] Enable submit search feedback link
 * @example
...
MapboxGeocoder.prototype = {
  ...
  onAdd: function(map) {
    ...
    if (this.options.feedback) {
      this._inputEl.addEventListener('blur', function(e) {
        // prevent suggestions from collapsing results before you can click feedback link
    ...
    if (this.options.feedback) {
      ...
      this.feedbackLink.className = 'geocoder-feedback';
      this.feedbackLink.innerText = 'Submit search feedback';
  ...
  _onKeyDown: function(e) {
    ...
    if (this.options.feedback) {
      ...
      this.feedbackLink.href = 'https://labs.mapbox.com/geocoder-feedback#search=' + this._inputEl.value + '?options=' + JSON.stringify(this.options);
      this.feedbackLink.setAttribute('tabindex', 0); // make it tabbable
      this.feedbackLink.style.display = 'block';
      wrapper.appendChild(this.feedbackLink);
    }
  ...
  _clear: function(ev) {
    ...
    this._inputEl.focus();
    this._clearEl.style.display = 'none';
    if (this.options.feedback) this.feedbackLink.style.display = 'none';
    this.lastSelected = null;
