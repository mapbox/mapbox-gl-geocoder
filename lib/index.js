...
MapboxGeocoder.prototype = {
  options: {
    ...
    render: function(feature){
      var maki;
      if (feature.properties.maki) maki = feature.properties.maki;
      else maki = 'marker'
      return `<img src="https://unpkg.com/@mapbox/maki@6.1.0/icons/${maki}-11.svg"/> ${feature.place_name}`;
    },
  ...
  onAdd: function(map) {
    ...
    this._typeahead.render = this.options.render;
