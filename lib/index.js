...
MapboxGeocoder.prototype = {
  ...
  _onChange: function() {
    ...
    if (selected) {
      if (selected.type === 'Query' && selected.properties.querystring){
        ...
        this.query(selected.properties.querystring);
        return;
      }
  ...
  _geocode: function(searchInput) {
    ...
    var mbGeocoderReq = this.mapboxClient.geocodeForward(searchInput, this.options);
    var request;
   ...
   * @returns {MapboxGeocoder} this
   */
  setInput: function(searchInput) {// Set input value to passed value and clear everything else.
