...
class MapboxEventManager {
   ...
   */
  getEventPayload(event, geocoder, eventArgs = {}) {
   ...
   */
  getSelectedIndex(selected, geocoder) {
   ...
   * @returns
   */
  objectHasRequiredProps(obj, requiredProps) {
