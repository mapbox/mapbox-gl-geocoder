...
/**
 * varruct a new mapbox event client to send interaction events to the mapbox event service
...
function MapboxEventManager(options){
  ...
  this.enableEventLogging = this.shouldEnableLogging();
...
MapboxEventManager.prototype = {
  ...
  send: function(payload, callback){
    if (!this.enableEventLogging) return callback();
